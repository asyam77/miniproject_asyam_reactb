            ...
            <form onSubmit={handleSubmit} className="container mt-5 w-50" id="productForm">
                ...
                <div className="mb-4 w-50">
                    ...
                    >
                        ...
                        <option name="category" value="iPhone">
                            iPhone
                        </option>
                        <option name="category" value="iPad">
                            iPad
                        </option>
                        <option name="category" value="Accessories">
                            Accessories
                        </option>
                ...
                <div className="mb-4">
                    ...
                    <div className="form-check">
                        <input
                            checked={dataEdit.productFreshness == "Baru"}
                            id="Baru"
                    ...
                    <div className="form-check">
                        <input
                            checked={dataEdit.productFreshness == "Bekas"}
                            id="Bekas"
                            name="productFreshness"
                            className="form-check-input"
                            type="radio"
                        ...
                        />
                        <label className="form-check-label" htmlFor="second">Bekas</label>
                    </div>
                    <div className="form-check">
                        <input
